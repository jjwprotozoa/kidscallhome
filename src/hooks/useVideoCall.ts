        ...
        async (payload) => {
          try {
            ...
            if (
              ...
              console.info(
                "🛑 [CALL LIFECYCLE] Call ended by remote party - cleaning up",
                {
              ...
              console.log(
                "🛑 [CALL LIFECYCLE] Call ended by remote party - cleaning up immediately",
                {
                  iceState,
                  reason:
              ...
              // Navigate based on route-based isChild state
              // CRITICAL: Use route-based isChild state instead of re-checking sessions
              // This ensures correct navigation even if sessions are cleared during call
              console.log(
                "🔍 [USER TYPE DETECTION] Termination listener - navigating based on route:",
                {
                  isChild,
                  route: window.location.pathname,
                  timestamp: new Date().toISOString(),

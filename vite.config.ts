...
export default defineConfig(({ mode }) => {
  // Plugin to inject OG image URL and modulepreload links based on environment
  const htmlPlugin = () => {
    return {
      name: "html-transform",
      transformIndexHtml(html: string, ctx) {
        ...
        // Note: Vite automatically adds modulepreload links for all chunks,
        // including vendor chunks. No manual injection needed.
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          description: "Stay connected with your family through simple video calls and messaging",
          theme_color: "#ffffff",
